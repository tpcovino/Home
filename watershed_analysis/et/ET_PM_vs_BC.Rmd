...
Evapotranspiration (ET) refers to the combined losses of water from the land surface to the atmosphere via evaporation and transpiration. Transpiration is loss of water from plants to the atmosphere and often accounts for a majority of total ET. Due to challenges in measuring ET, many estimation approaches have been developed. In this lab we will use two common methods: the Blaney-Criddle and FAO-56 Penman-Monteith approaches to estimating ET. Please work through the lab, including required readings and videos, up to the synthesis questions prior to lab on Thursday. During Thursday lab we will work on modeling ET in R and I will get you started on the project. You are welcome to collaborate with your colleagues in class but all work submitted and all responses must be your own.

## Overall Learning Objectives:

At the end of this module, students will understand the key processes driving evaporation and transpiration. Additionally, students will estimate ET using the Blaney-Criddle and FAO-56 Penman-Monteith methods, evaluate differences in ET between sites of widely different climates, identify how the two ET models differ, and evaluate the advantages and disadvantages of each.
...
[Step-by-step calculation of refernce ET using the FAO-56  Penman-Monteith](https://edis.ifas.ufl.edu/pdf/AE/AE45900.pdf)

## Supplemental reading: 

[The surface energy budget](http://www.met.reading.ac.uk/~swrhgnrj/teaching/MT23E/mt23e_notes.pdf)
...
### Understanding ET in irrigated systems is important becaue the large majority of water used globally is for irrigation. See [Qin et al., (2020)](https://www.nature.com/articles/s41558-020-0746-8) for suplemental reading on changing snowmelt and irrigated agriculture. 
