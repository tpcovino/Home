...
The term evapotranspiration ET is commonly used for two water loss processes from land surface to atmosphere (Evaporation and Transpiration).  Evaporation is the process where water liquid is converted to water vapor from sources such as soil surface, wet vegetation, pavement, lakes, oceans, etc. Transpiration consists of the vaporization of liquid water within the plant and subsequent loss of water through leaf stomata. Evaporation and transpiration occur simultaneously, and both are affected by solar radiation, air temperature, vapor pressure deficit, and wind speed. In this study, we are focusing on measuring evapotranspiration using two widely used ET equations, Blaney-Criddle and Penman-Monteith, and discuss their strengths and weaknesses by applying it to two climatically different regions. The appropriateness of the applied equations will be discussed in detail for each climatic region.

## Overall Learning Objectives:

At the end of this module, students will be able to explain the key variables for calculating ET and what environmental factors directly affect it. Additionally, students will estimate ET using Penman-Monteith and Blaney-Criddle methods, identify how these ET methods differ methodologically, and discern which method should be considered based on a climatic region. 

## Required Reading and Links:

[Evaporation Introduction (Video)](https://www.youtube.com/watch?v=4765Sg2mKco){target="_blank"}

<iframe width="560" height="315" src="https://www.youtube.com/embed/4765Sg2mKco" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
[Step by Step Calculation of the Penman-Monteith Evapotranspiration (FAO-56 Method) ](https://edis.ifas.ufl.edu/ae459){target="_blank"}
...
[Youtube video: What is evapotranspiration?](https://www.youtube.com/watch?v=EuW9Sd3i_mY){target="_blank"}”

<iframe width="560" height="315" src="https://www.youtube.com/embed/EuW9Sd3i_mY" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

When measuring ET, standardizing crop evapotranspiration, ETC, refers to large productive fields of crops grown under optimal soil water, management, and environmental conditions. If conditions deviate from standard ETC, correction factors are necessary to reflect any effects from environmental or management conditions.

###  c. Energy factors required for ET 
...
[Figure 1](https://www.google.com/url?q=http://www.fao.org/3/X0490E/x0490e0a.htm%23factors%2520determining%2520the%2520crop%2520coefficient&sa=D&ust=1607216950112000&usg=AOvVaw2V3a8_1H5CgviYD_Ynxo5r){target="_blank"}: The effect of evaporation on Kc. The horizontal line represents Kc when the soil surface is kept continuously wet. The curved line corresponds to Kc when the soil surface is kept dry but the crop receives sufficient water to sustain full transpiration. Figure and caption courtesy of FAO.
Not all crop evapotranspiration happens under perfect conditions, however. ETC adj is ETC that happens under non-standard conditions, such as higher soil salinity, disease or pests, low soil fertility, or high or low water quantities, all of which may affect and lower the rate of ETC. Accounting for ETC adj is calculated with a water stress coefficient KS, or adjusting KC. 
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/kSMA94T4SJc" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

# 2. Modeling ET

###  a. Penman-Monteith

Penman equations operate on an energy balance and mass transfer method to estimate evaporation from open water, bare soil, and grass using climatological data:
...
Ideally, we would be able to determine the evapotranspiration for a reference crop to determine its water needs. However, there are multiple variables required, and ETC and ETC adj have numerous coefficients that make daily calculations ponderous. For example, the FAO provides guidance on determining crop coefficients for single and dual crops with both available water and water stress under initial, mid and late-season changes for natural, non-typical and non-pristine vegetation under several management practices. It is easy to assign a single value crop reference as Blaney-Criddle does, but this does not give an accurate rate of ET. 

Numerous variables are necessary to calculate Penman-Montieth, but for the sake of this module, it will be simplified to open water (assuming water is readily available) and thus is potential evaporation. Potential evaporation is the upward bound of evapotranspiration as water is unlimited and is able to move freely into the air above the land surface. Rather than Penman-Montieth, we are using the derivation by Shuttleworth that standardizes measurement heights at two meters for wind speed, temperature, and humidity. In comparison to Penman-Montieth, Shuttleworth excludes ground heat flux, G, assuming that when taken at daily time steps, G is negligible. The Shuttleworth equation also does not factor in aerodynamic resistance, ra, as surface roughness is not a variable commonly measured at weather stations. Similarly, surface resistance, rs, is also not variable measured since it comprises how water moves through roots, xylem, leaves and soil on a daily basis.

For the basis of this module, students will compare the upper limit of evaporation using the Shuttleworth equation vs. the temperature based Blaney-Criddle. 

###  d. Data Source

[SCAN Network](https://www.wcc.nrcs.usda.gov/scan/scan_brochure.pdf){target="_blank"}”
...
Table 2. SCAN network variables and methods of collection
...
[R tutorial](https://www.youtube.com/embed/JQ-0cVKFcZo){target="_blank"}

<iframe width="560" height="315" src="https://www.youtube.com/embed/JQ-0cVKFcZo" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
