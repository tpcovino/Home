...
```{r}
data <- read_csv(here('/data', 'csasn_vf_metab_env_p_values_long.csv'))
...
f <- ggplot(po4, aes(x = Vf, y = Conc, color = 'Site')) + 
  geom_point() + 
  geom_line() +
  theme_few()
...
i8in_temp_NH4_Vf.lm = lm(NH4_Vf ~ Temp, data = i8in)
summary(i8in_temp_NH4_Vf.lm)


i8in_PAR_NH4_Vf.lm = lm(NH4_Vf ~ PAR, data = i8in)
summary(i8in_PAR_NH4_Vf.lm)

i8in_Q_NH4_Vf.lm = lm(NH4_Vf ~ Q, data = i8in)
summary(i8in_Q_NH4_Vf.lm)

i8in_N_NH4_Vf.lm = lm(NH4_Vf ~ NH4, data = i8in)
summary(i8in_N_NH4_Vf.lm)

#Get summary stats for lm on NO3_Vf at I8-In
i8in_temp_NO3_Vf.lm = lm(NO3_Vf ~ Temp, data = i8in)
summary(i8in_temp_NO3_Vf.lm)


i8in_PAR_NO3_Vf.lm = lm(NO3_Vf ~ PAR, data = i8in)
summary(i8in_PAR_NO3_Vf.lm)

i8in_Q_NO3_Vf.lm = lm(NO3_Vf ~ Q, data = i8in)
summary(i8in_Q_NO3_Vf.lm)

i8in_N_NO3_Vf.lm = lm(NO3_Vf ~ NO3, data = i8in)
...
i8out_temp_NH4_Vf.lm = lm(NH4_Vf ~ Temp, data = i8out)
summary(i8out_temp_NH4_Vf.lm)

i8out_PAR_NH4_Vf.lm = lm(NH4_Vf ~ PAR, data = i8out)
summary(i8out_PAR_NH4_Vf.lm)

i8out_Q_NH4_Vf.lm = lm(NH4_Vf ~ Q, data = i8out)
summary(i8out_Q_NH4_Vf.lm)

i8out_N_NH4_Vf.lm = lm(NH4_Vf ~ NH4, data = i8out)
summary(i8out_N_NH4_Vf.lm)

#Get summary stats for lm on NO3_Vf at I8-Out
i8out_temp_NO3_Vf.lm = lm(NO3_Vf ~ Temp, data = i8out)
summary(i8out_temp_NO3_Vf.lm)

i8out_PAR_NO3_Vf.lm = lm(NO3_Vf ~ PAR, data = i8out)
summary(i8out_PAR_NO3_Vf.lm)

i8out_Q_NO3_Vf.lm = lm(NO3_Vf ~ Q, data = i8out)
summary(i8out_Q_NO3_Vf.lm)

i8out_N_NO3_Vf.lm = lm(NO3_Vf ~ NO3, data = i8out)
...
pin_temp_NH4_Vf.lm = lm(NH4_Vf ~ Temp, data = pin)
summary(pin_temp_NH4_Vf.lm)

pin_PAR_NH4_Vf.lm = lm(NH4_Vf ~ PAR, data = pin)
summary(pin_PAR_NH4_Vf.lm)

pin_Q_NH4_Vf.lm = lm(NH4_Vf ~ Q, data = pin)
summary(pin_Q_NH4_Vf.lm)

pin_N_NH4_Vf.lm = lm(NH4_Vf ~ NH4, data = pin)
summary(pin_N_NH4_Vf.lm)

#Get summary stats for lm on NO3_Vf at P-In
pin_temp_NO3_Vf.lm = lm(NO3_Vf ~ Temp, data = pin)
summary(pin_temp_NO3_Vf.lm)

pin_PAR_NO3_Vf.lm = lm(NO3_Vf ~ PAR, data = pin)
summary(pin_PAR_NO3_Vf.lm)

pin_Q_NO3_Vf.lm = lm(NO3_Vf ~ Q, data = pin)
summary(pin_Q_NO3_Vf.lm)

pin_N_NO3_Vf.lm = lm(NO3_Vf ~ NO3, data = pin)
