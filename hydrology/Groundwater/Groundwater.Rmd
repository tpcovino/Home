...
# Gateway Natural Area - Poudre River (105 pts)
...
Complete the following assignment to prepare for using real-world groundwater data.
  ...
  + [Groundwater assessment, 40 pts](https://www.dropbox.com/s/me8sfvzkox60v52/GW_v2.docx?dl=0)
...
- Measure temperature and specific conductivity in each of the wells and at both gauging locations (up and downstream in the river)
- Please note that the conductivity sensor will provide conductivity in both compensated and non-compensated formats. You want compensated. Conductivity that is compensated for standard temperature (25 C) is called specific conductance or specific conductivity and is abbreviate SC. SC is typically in units of microsiemens per centimeter (S/cm) or milisiemens per centimeter (mS/cm) 
...
<br>
Here is an example of a 3-point problem:

<iframe width="560" height="315" src="https://www.youtube.com/embed/rNNGkWRuF8s" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen data-external = "1"></iframe>




# Supplemental reading on quantifying stream-GW exchange using hydrometric and geochemical tracers

  + [Covino and McGlynn, 2007](https://www.dropbox.com/s/waggp9l4dt2wepe/Covino%20and%20McGlynn%202007%20stream%20gains%20loss.pdf?dl=0)
